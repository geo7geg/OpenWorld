...
-- Χρόνος δημιουργίας: 26 Ιουν 2015 στις 08:50:19
...
INSERT INTO `variables` (`def_fact`, `off_fact`, `pol_stab`, `diaspora`, `immune`, `level`, `craft_per`, `dealer_per`, `reg_dev_ab`, `box_id`, `ini`, `in_regions`, `dev_margin`, `army_percent_sunasp`, `army_percent_enwsi`, `gold_percent`, `farm_percent`, `craft_percent`, `dealer_percent`, `army_percent`, `enwsi_leader_rounds`, `enwsi_vote_rounds`, `enwsi_break_rounds`) VALUES
('0.3', '0.1', '1.00', 10, 10, 1, 30, 20, 100, 1, 1, 10, 10, '0.3', '0.4', '0.20', '0.20', '0.20', '0.20', '0.40', 12, 5, 5);
