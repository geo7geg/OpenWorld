...
-- Χρόνος δημιουργίας: 09 Ιουν 2015 στις 11:54:06
...
INSERT INTO `variables` (`def_fact`, `off_fact`, `pol_stab`, `diaspora`, `immune`, `level`, `craft_per`, `dealer_per`, `reg_dev_ab`, `box_id`, `ini`, `in_regions`, `dev_margin`) VALUES
('0.3', '0.1', '1.00', 10, 10, 1, 30, 20, 100, 1, 1, 10, 10);
