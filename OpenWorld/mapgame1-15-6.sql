...
-- Χρόνος δημιουργίας: 15 Ιουν 2015 στις 14:25:09
...
INSERT INTO `variables` (`def_fact`, `off_fact`, `pol_stab`, `diaspora`, `immune`, `level`, `craft_per`, `dealer_per`, `reg_dev_ab`, `box_id`, `ini`, `in_regions`, `dev_margin`, `army_percent_sunasp`) VALUES
('0.3', '0.1', '1.00', 10, 10, 1, 30, 20, 100, 1, 1, 10, 10, '0.3');
