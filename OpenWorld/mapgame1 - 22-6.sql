...
-- Χρόνος δημιουργίας: 22 Ιουν 2015 στις 09:35:15
...
INSERT INTO `player` (`id`, `name`, `surname`, `username`, `password`, `gold`, `military`, `political`, `diplomatic`, `trade`, `rev_sum`, `cost_sum`, `free_army`, `army_debt_sunasp`, `army_given_sunasp`, `sunasp`, `army_debt_enwsi`, `army_given_enwsi`, `enwsi`) VALUES
...
INSERT INTO `variables` (`def_fact`, `off_fact`, `pol_stab`, `diaspora`, `immune`, `level`, `craft_per`, `dealer_per`, `reg_dev_ab`, `box_id`, `ini`, `in_regions`, `dev_margin`, `army_percent_sunasp`, `army_percent_enwsi`, `gold_percent`, `farm_percent`, `craft_percent`, `dealer_percent`, `army_percent`) VALUES
('0.3', '0.1', '1.00', 10, 10, 1, 30, 20, 100, 1, 1, 10, 10, '0.3', '0.4', '0.20', '0.20', '0.20', '0.20', '0.40');
